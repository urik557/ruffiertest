...
def test(P1, P2, P3, age):
    ...
    if int(age.text) < 7:
        ...
        ruff_index = ruffier_index(int(P1.text),int(P2.text),int(P3.text))
        result = txt_res[ruffier_result(ruff_index,neud_level(int(age.text)))]
